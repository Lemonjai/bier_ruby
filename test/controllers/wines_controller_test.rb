...
class WinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wine" do
    assert_difference('Wine.count') do
      post wines_url, params: { wine: { beerType: @wine.beerType, brewery: @wine.brewery, color: @wine.color, food: @wine.food, occassion: @wine.occassion, rating: @wine.rating, title: @wine.title } }
    end
  ...
  test "should update wine" do
    patch wine_url(@wine), params: { wine: { beerType: @wine.beerType, brewery: @wine.brewery, color: @wine.color, food: @wine.food, occassion: @wine.occassion, rating: @wine.rating, title: @wine.title } }
