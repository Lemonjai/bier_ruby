...
class ColoursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create colour" do
    assert_difference('Colour.count') do
      post colours_url, params: { colour: { colour: @colour.colour, hexcode: @colour.hexcode } }
    end
  ...
  test "should update colour" do
    patch colour_url(@colour), params: { colour: { colour: @colour.colour, hexcode: @colour.hexcode } }
