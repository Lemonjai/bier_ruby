...
class BeersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post beers_url, params: { beer: { beerType: @beer.beerType, brewery: @beer.brewery, color: @beer.color, food: @beer.food, occassion: @beer.occassion, rating: @beer.rating, title: @beer.title } }
    end
  ...
  test "should update beer" do
    patch beer_url(@beer), params: { beer: { beerType: @beer.beerType, brewery: @beer.brewery, color: @beer.color, food: @beer.food, occassion: @beer.occassion, rating: @beer.rating, title: @beer.title } }
